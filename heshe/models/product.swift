...
class product : NSObject, NSCoding{
    ...
    var id : Int!
    var images : [prodImage]!
    var manageStock : Bool!
    var menuOrder : Int!
    var metaData : [prodMetaDatum]!
    var name : String!
    var onSale : Bool!
    var parentId : Int!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let linksData = dictionary["_links"] as? [String:Any]{
            links = prodLink(fromDictionary: linksData)
        }
        if let dimensionsData = dictionary["dimensions"] as? [String:Any]{
            dimensions = prodDimension(fromDictionary: dimensionsData)
        }
        attributes = [prodAttribute]()
        if let attributesArray = dictionary["attributes"] as? [[String:Any]]{
            for dic in attributesArray{
                let value = prodAttribute(fromDictionary: dic)
        ...
        if let categoriesArray = dictionary["categories"] as? [[String:Any]]{
            for dic in categoriesArray{
                let value = prodCategory(fromDictionary: dic)
        ...
        if let imagesArray = dictionary["images"] as? [[String:Any]]{
            for dic in imagesArray{
                let value = prodImage(fromDictionary: dic)
                images.append(value)
            }
        }
        metaData = [prodMetaDatum]()
        if let metaDataArray = dictionary["meta_data"] as? [[String:Any]]{
            for dic in metaDataArray{
                let value = prodMetaDatum(fromDictionary: dic)
        ...
        if let tagsArray = dictionary["tags"] as? [[String:Any]]{
            for dic in tagsArray{
                let value = prodTag(fromDictionary: dic)
                tags.append(value)
            }
        }
    }
    ...
    {
        links = aDecoder.decodeObject(forKey: "_links") as? prodLink
        attributes = aDecoder.decodeObject(forKey: "attributes") as? [prodAttribute]
        ...
        categories = aDecoder.decodeObject(forKey: "categories") as? [prodCategory]
        ...
        dimensions = aDecoder.decodeObject(forKey: "dimensions") as? prodDimension
        ...
        images = aDecoder.decodeObject(forKey: "images") as? [prodImage]
        manageStock = aDecoder.decodeObject(forKey: "manage_stock") as? Bool
        menuOrder = aDecoder.decodeObject(forKey: "menu_order") as? Int
        metaData = aDecoder.decodeObject(forKey: "meta_data") as? [prodMetaDatum]
        ...
        tags = aDecoder.decodeObject(forKey: "tags") as? [prodTag]
        ...
        cantOr = aDecoder.decodeObject(forKey: "cantOr") as? Int
    }
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if cantOr != nil{
            aCoder.encode(cantOr, forKey: "cantOr")
        }
    }
}
